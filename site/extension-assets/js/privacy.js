...
const applyPrivacyLanguage = (language) => {
  ...
  if (privacyElements.languageToggleLabel) {
    privacyElements.languageToggleLabel.textContent = activePrivacyLanguage.toUpperCase();
  }
  ...
  setText(".header-action--back span", "footerHome");
