...
const welcomeTranslations = extendPageTranslations({
  "pt-BR": {
    ...
    footerHome: "Início",
    footerLegal: "© RecarregaAi! 2.4.0. Todos os direitos reservados.",
  ...
  en: {
    ...
    footerFeedback: "Feedback",
    footerHome: "Home",
    footerLegal: "© RecarregaAi! 2.4.0. All rights reserved.",
  ...
  es: {
    ...
    footerFeedback: "Feedback",
    footerHome: "Inicio",
    footerLegal: "© RecarregaAi! 2.4.0. Todos los derechos reservados.",
